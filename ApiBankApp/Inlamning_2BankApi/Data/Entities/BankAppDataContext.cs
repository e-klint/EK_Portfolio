...
namespace ApiBankApp.Data.Entities;
...
public partial class BankAppDataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC0711C82662");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E41CD2BE1C").IsUnique();
